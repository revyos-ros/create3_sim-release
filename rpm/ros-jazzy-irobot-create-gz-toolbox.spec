...
Name:           ros-jazzy-irobot-create-gz-toolbox
Version:        3.0.4
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS irobot_create_gz_toolbox package
...
%description
Nodes and tools for simulating in Ignition iRobot(R) Create(R) 3 Educational
Robot.
